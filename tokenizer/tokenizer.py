...
if __name__ == '__main__':
    ...
    print 'the top 20 hashtags associated with #happy:'
    print protect1.mostCommHashtag('#happy')
    print 'the top 20 hashtags associated with #sad:'
    print protect1.mostCommHashtag('#sad')
    print 'the top 20 nouns associated with #happy:'
    print protect1.mostCommNouns('#happy')
    print 'the top 20 nouns associated with #sad:'
    print protect1.mostCommNouns('#sad')
    print 'the top 20 verbs associated with #happy:'
    print protect1.mostCommVerbs('#happy')
    print 'the top 20 verbs associated with #sad:'
    print protect1.mostCommVerbs('#sad')
    print 'the conditional proportions of hashtags associated with "#happy":'
    print protect1.conditionalProportion('#happy')
    print 'the conditional proportions of hashtags associated with #sad:'
    print protect1.conditionalProportion('#sad')
